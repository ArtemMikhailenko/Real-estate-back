      ...
      return {
        ...
        profilePicture:
          friend.profilePicture && typeof friend.profilePicture === 'string'
            ? `http://localhost:5001/uploads/${path.basename(friend.profilePicture)}`
            : null,
      };
    });
      ...
      requester: {
        ...
        profilePicture:
          request.user.profilePicture && typeof request.user.profilePicture === 'string'
            ? `http://localhost:5001/uploads/${path.basename(request.user.profilePicture)}`
            : null,
      },
    }));
    ...
    const formattedUsers = users.map((user) => ({
      ...
      profilePicture:
        user.profilePicture && typeof user.profilePicture === 'string'
          ? `http://localhost:5001/uploads/${path.basename(user.profilePicture)}`
          : null,
    }));
      ...
      requester: {
        ...
        profilePicture:
          updatedFriendship.user.profilePicture && typeof updatedFriendship.user.profilePicture === 'string'
            ? `http://localhost:5001/uploads/${path.basename(updatedFriendship.user.profilePicture)}`
            : null,
      },
    };
